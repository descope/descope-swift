...
/// The ``DescopeLogger`` class can be used to customize how logging works in the Descope SDK.
///
/// Create a subclass of ``DescopeLogger`` and override the ``output(level:message:debug:)``
