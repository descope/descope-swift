...
///
/// When the enchanted link was sent via SMS instead (see e.g. ``DescopeEnchantedLink/signUpWithPhone(_:details:redirectURL:)``),
/// ``maskedPhone`` is populated instead of ``maskedEmail``.
